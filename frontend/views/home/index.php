<div class="header-top space-padding-tb-40">
    <div class="container">
        <div class="inside text-center">
            <!-- logo -->
            <div  id="logo-theme" class="logo-store"><a href="index.php@route=common_2Fhome" class="img-responsive"><span>Pavo Mode - Responsive Opencart Theme</span></a></div>
        </div>
    </div>
</div>
<!-- sys-notification -->
                                                    ...
                                                    <div class="tab-v1 ">
                                                        ...
                                                        <div class="tab-content panel-body">
                                                            ...
                                                            <div data-ride="owlcarousel" id="tab-bestseller1859047402" class="tab-pane fade box-products owl-carousel-play tabcarousel1859047402">
                                                                <div data-navigation="true" data-pagination="false" data-show="1" class="owl-carousel product-grid owl-theme" style="opacity: 0; display: block;">
                                                                    <div class="owl-wrapper-outer">
                                                                        <div class="owl-wrapper" style="width: 400px; left: 0px; display: block; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);">
