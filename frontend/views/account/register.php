<div class="row">
    <div class="col-sm-9" id="content">      
        ...
        <p>If you already have an account with us, please login at the <a href="http://opencart.local/index.php?route=account/login">login page</a>.</p>
        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="http://opencart.local/index.php?route=account/register">
            <fieldset id="account">
            ...
            <div class="buttons">
                <div class="pull-right">I have read and agree to the <a class="agree" href="http://opencart.local/index.php?route=information/information/agree&amp;information_id=3"><b>Privacy Policy</b></a>                        <input type="checkbox" value="1" name="agree">
                    &nbsp;
    ...
    <aside class="col-sm-3 hidden-xs" id="column-right">
        <div class="list-group">
            <a class="list-group-item" href="http://opencart.local/index.php?route=account/login">Login</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/register">Register</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/forgotten">Forgotten Password</a>
            <a class="list-group-item" href="http://opencart.local/index.php?route=account/account">My Account</a>
            <a class="list-group-item" href="http://opencart.local/index.php?route=account/address">Address Book</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/wishlist">Wish List</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/order">Order History</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/download">Downloads</a><a class="list-group-item" href="http://opencart.local/index.php?route=account/recurring">Recurring payments</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/reward">Reward Points</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/return">Returns</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/transaction">Transactions</a> <a class="list-group-item" href="http://opencart.local/index.php?route=account/newsletter">Newsletter</a>
        </div>
    </aside>
</div>